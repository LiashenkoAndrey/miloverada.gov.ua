...
public interface NewsRepository extends JpaRepository<News, Long> {
    ...
    @Query(
            "select new gov.milove.domain.dto.NewsDTO(n.id, n.description, n.image_id, n.created, n.newsType.title) FROM News n"
    )
    Page<NewsDTO> getPageOfDTO(Pageable pageable);

    @Query(
            "select new gov.milove.domain.dto.NewsDTO(n.id, n.description, n.image_id, n.created, n.newsType.title) " +
    ...
    @Query(
            "select new gov.milove.domain.dto.NewsDTO(n.id, n.description, n.image_id, n.created, n.newsType.title) from News n order by n.created desc"
    )
